    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-950 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1">Sign in to continue your placement prep</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-white/5 border border-white/10 text-sm font-medium text-gray-300 hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer"
            >
