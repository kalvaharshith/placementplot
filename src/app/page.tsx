    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link href="/signup" className="btn-primary text-sm px-5 py-2.5 flex items-center">
      ...
      {mobileOpen && (
        <div className="md:hidden glass mt-2 mx-4 rounded-xl p-4 animate-slide-down">
          ...
          <div className="mt-4 pt-4 border-t border-white/10 flex flex-col gap-2">
            <Link href="/login" onClick={() => setMobileOpen(false)} className="btn-secondary text-sm text-center py-2.5">Log In</Link>
            <Link href="/signup" onClick={() => setMobileOpen(false)} className="btn-primary text-sm text-center py-2.5"><span>Get Started Free</span></Link>
          </div>
        </div>
      )}
    </nav>
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-slide-up stagger-3" style={{ animationFillMode: "backwards" }}>
          <Link href="/signup" className="btn-primary text-lg px-8 py-4 group flex items-center">
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Link href="/signup" className="btn-primary text-lg px-10 py-4 inline-flex items-center group">
          <span className="flex items-center">
            Start Free Today
            <ArrowRightIcon />
          </span>
